...
A real-time, encrypted chat application built using **Python sockets**, **AES encryption**, and **MySQL** for secure message storage and private communication between users.  
